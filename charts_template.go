...
func getFooter() string {
	summary := "{{.Summary}}"
	return fmt.Sprintf(`<div class="footer"><img valign="middle" src='data:image/png;base64,%v'></img><img valign="middle" src='data:image/png;base64,%v'> %v</img></div>`,
		POSPOS_ICO, CHEN_ICO, summary)
}
...
func GetChartTemplate(chartType string) (*template.Template, error) {
	...
	<h2 style="maring-top:10px;">{{.Operation}}</h2>
